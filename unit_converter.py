...
def convert_unit(system, unit_from, unit_to, value_from):
...
while True:
    system = input("Enter the unit system: ")
    
    if system not in conversion_factors:
        print("This system doesn't exist or you have entered it incorrectly!\n")
        continue
    
    unit_from = input("Select the unit you want to convert from: ")
    unit_to = input("Select the unit you want to convert to: ")
    
    if unit_from not in conversion_factors[system] or unit_to not in conversion_factors[system]:
        print("The unit you're trying to convert doesn't exist in the unit system!\n")
        continue
    
    try:
        value_from = float(input("Enter the value to convert: "))
        
    except ValueError:
        print("The entry is not valid!\n")
        continue
    
    convert_unit(system, unit_from, unit_to, value_from)
