...
df_train = pd.read_csv(r'https://github.com/fsguerreiro/my_portfolio/main/Streamlit_files/titanic_train.csv')
df_test = pd.read_csv(r'https://github.com/fsguerreiro/my_portfolio/main/Streamlit_files/titanic_test.csv')
